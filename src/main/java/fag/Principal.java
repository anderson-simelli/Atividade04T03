...
//		questao9_WhileScanner(scan);
	...
	public static void questao6_Metodos() {
		...
		int n1 = 10; 
		int n2 = 6;
		int maior1 = encontrarMaior(n1, n2);
		System.out.println("Entre " + n1 + " e " + n2 + ", o maior é: " + maior1);
	...
	public static void questao9_WhileScanner(Scanner scan) {
		...
		System.out.println(" Quantidade de números digitados: " + contadorPositivos);
		System.out.println();
	}
	...
	public static void questao10_MetodosFor() {
		...
		int valor1 = 5;
		 System.out.println("O fatorial de " + valor1 + " é: " + calcularFatorial(valor1));
